...
def get_plugin(module_name, sources, headers=None, source_dir=None, **build_kwargs):
    ...
    try: # pylint: disable=too-many-nested-blocks
        ...
        if len(all_source_dirs) == 1: # and ('TORCH_EXTENSIONS_DIR' in os.environ):
            ...
            build_top_dir = torch.utils.cpp_extension._get_build_directory(module_name, verbose=verbose_build) # '/lustre/home/ssanyal/.cache/torch_extensions/py38_cu113/' + module_name # pylint: disable=protected-access
